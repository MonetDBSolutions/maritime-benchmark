...
shp2pgsql -I -s 4326 '/path/to/data/[C2] IHO World Seas/World_Seas_IHO_v2.shp.shp' geographic_features.world_seas | psql  -d $db_name;
...
shp2pgsql -I -s 3035 '/path/to/data/[C5] $db_name Protected Areas (EEA Natura 2000)/spatial data/Natura2000_end2015.shp' natura2000.spatialfeatures | psql  -d $db_name;